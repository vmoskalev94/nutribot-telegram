...
public class TelegramClient {
    ...
    public void sendMainMenu(Long chatId) {
        String greeting = """
                Привет! Я NutriBot — бот, который поможет вести тренировки и считать нутриенты.
                
                Сейчас доступно только главное меню-каркас. Дальше добавим онбординг, профиль, тренировки и расчёт нутриентов 💪
                """;
